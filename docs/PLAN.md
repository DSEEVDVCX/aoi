...
**النتيجة الأهمّ حتى الآن**: الخروج يهزم اختيار العملات.
...
الاحتفاظ طمعاً في القمّة يحوّل وسيطاً **+10% إلى −3%**. وهذا يعني أنّ **ضبط قاعدة
الخروج قد يفوق أثره أثر النموذج كلّه** — جرّبها قبل أن تستثمر أسابيع في النمذجة.

⚠️ نافذة الخروج الزمنية تتعارض ظاهرياً مع أنّ **47% تبلغ قمّتها بعد 12 ساعة**
(الوسيط 11.4س): الخروج المبكّر يقطع مكاسب القمّة **لكنّه يتفادى الانهيار أيضاً**،
والمحصّلة موجبة. لا تفترض — أعِد التشغيل بعد نضج النوافذ.
