...
### 4.2 قواعد الخروج المرشَّحة

اختبرها كلّها؛ الفرق بينها قد يفوق الفرق بين النماذج:

1. جني ثابت (+50% أو +100%)
2. وقف خسارة (−30%)
3. وقف متحرّك (trailing) — يناسب توزيعاً ملتوياً
4. خروج زمنيّ (بعد 24 ساعة مهما كان)
5. تركيبة: وقف + جني + سقف زمنيّ

**المرجع من بياناتك**: الوسيط الحقيقي للمدّة حتى القمّة **11.4 ساعة**، و47%
تبلغ قمّتها بعد 12 ساعة ⇒ الخروج قبل 12 ساعة يقطع نصف المكاسب.
