...
# الأحواض تعيش في ذاكرة كل عمليّة، واللوحة تقرأ القاعدة فقط ⇒ كل عمليّة تختم
# صفَّها `provider_keys_<owner>` في meta. **أعدادٌ ومؤشّرات لا قيم** (FR-013):
# اللوحة لا تعرض مفتاحاً ولا كسراً منه، ولا تستطيع ذلك أصلاً — القيمة لا تُكتب.
