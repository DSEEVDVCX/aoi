...
- **صحّة الجمع**: مقياس تغطية الشموع + نسبة الدورات الناجحة + حجم/مدى الأرشيف.
...
|---|---|
| `GET /` | الصفحة |
| `GET /api/status` | حالة المسجّل (حيّ، عدّ الدورات، آخر دورة…) |
...
| `GET /api/storage` | حجم الأرشيف ومعدّل نموّه اليوميّ |
